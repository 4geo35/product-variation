...
class OrderStatePolicy implements PolicyPermissionInterface
{
    const PERMISSION_KEY = "order_states";
    const VIEW_ALL = 2;
    const CREATE = 4;
    const UPDATE = 8;
    const DELETE = 16;
    ...
    public function update(User $user, OrderStateInterface $orderState): bool
    {
        return PermissionActions::allowedAction($user, self::PERMISSION_KEY, self::UPDATE);
    }

    public function delete(User $user, OrderStateInterface $orderState): bool
    {
